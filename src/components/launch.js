...
import { ContentCentered } from "./styles/styles"
...
const ImageDiv = styled.div`
  ...
  background: url(${props =>
    props.bcdUrl || 'https://live.staticflickr.com/65535/50618376671_ba4e60af7c_z.jpg'});
`;
      ...
      >
        {images.map((image) => (
          <a href={image} key={image}>
            <ImageDiv bcdUrl={image.replace("_o.jpg", "_z.jpg")}></ImageDiv>
          </a>
        ))}
      </SimpleGrid>
    </ContentCentered>
...
function ImageOpened(imageUrl) {
  return(<OpenedImage bcdUrl={imageUrl} />)
}